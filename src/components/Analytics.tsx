...
/**
 * Renders nothing unless a container ID is configured. The agency supplies
 * their own container and owns the data — no tracking account of ours is
 * hard-wired into the site.
 */
